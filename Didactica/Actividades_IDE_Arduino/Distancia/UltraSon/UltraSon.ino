 ...
 *  conectado a la entrada/salida I/O1 "D4", como solo tiene un pin,
 *  une los pines Trigger y ECHO del HC-SR04 y conéctalos al D4.
 *+--------------------------------+
  |     _.-.,            _.-.,     |
  |    /     \          /     \    |
  |   |       |        |       |   |
...
void loop() {
  ...
  unsigned long tiempo = pulseIn(IO1, HIGH);

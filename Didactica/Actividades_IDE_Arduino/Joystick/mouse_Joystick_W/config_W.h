...
#define L_Orange 12  //Led naranja
#define L_Green 11   //Led verde
...
#define J_X A0     //Entrada analógica conectada al joystick X
#define J_Y A1     //Entrada analógica conectada al joystick Y
